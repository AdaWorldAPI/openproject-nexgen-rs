...
//! `QueriesMembersFiltersEntityTypeFilter` — canonical class generated from `ogar_vocab::queries::members::filters::entitytypefilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::members::filters::entitytypefilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesMembersFiltersEntityTypeFilter {
}

impl QueriesMembersFiltersEntityTypeFilter {
    ...
    pub fn r#type(&self) {
        // TODO: port `type` from Queries::Members::Filters::EntityTypeFilter
    }

    /// OGAR action `allowed_values` (DO-arm).
    pub fn allowed_values(&self) {
        // TODO: port `allowed_values` from Queries::Members::Filters::EntityTypeFilter
    }
}