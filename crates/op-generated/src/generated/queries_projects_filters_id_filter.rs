...
//! `QueriesProjectsFiltersIdFilter` — canonical class generated from `ogar_vocab::queries::projects::filters::idfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::projects::filters::idfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesProjectsFiltersIdFilter {
}

impl QueriesProjectsFiltersIdFilter {
    ...
    pub fn human_name(&self) {
        // TODO: port `human_name` from Queries::Projects::Filters::IdFilter
    }
}