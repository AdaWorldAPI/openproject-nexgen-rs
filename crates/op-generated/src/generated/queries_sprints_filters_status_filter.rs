...
//! `QueriesSprintsFiltersStatusFilter` — canonical class generated from `ogar_vocab::queries::sprints::filters::statusfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::sprints::filters::statusfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesSprintsFiltersStatusFilter {
}

impl QueriesSprintsFiltersStatusFilter {
    ...
    pub fn allowed_values(&self) {
        // TODO: port `allowed_values` from Queries::Sprints::Filters::StatusFilter
    }

    /// OGAR action `type` (DO-arm).
    pub fn r#type(&self) {
        // TODO: port `type` from Queries::Sprints::Filters::StatusFilter
    }
}