...
//! `QueriesTimeEntriesFiltersUpdatedAtFilter` — canonical class generated from `ogar_vocab::queries::timeentries::filters::updatedatfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::timeentries::filters::updatedatfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesTimeEntriesFiltersUpdatedAtFilter {
}

impl QueriesTimeEntriesFiltersUpdatedAtFilter {
    ...
    pub fn r#type(&self) {
        // TODO: port `type` from Queries::TimeEntries::Filters::UpdatedAtFilter
    }
}