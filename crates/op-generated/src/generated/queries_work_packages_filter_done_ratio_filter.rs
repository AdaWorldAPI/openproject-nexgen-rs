...
//! `QueriesWorkPackagesFilterDoneRatioFilter` — canonical class generated from `ogar_vocab::queries::workpackages::filter::doneratiofilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::workpackages::filter::doneratiofilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesWorkPackagesFilterDoneRatioFilter {
}

impl QueriesWorkPackagesFilterDoneRatioFilter {
    ...
    pub fn r#type(&self) {
        // TODO: port `type` from Queries::WorkPackages::Filter::DoneRatioFilter
    }
}