...
//! `ImportJiraStatus` — canonical class generated from `ogar_vocab::import::jirastatu()`.
...
pub const CANONICAL_CONCEPT: &str = "import::jirastatu";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct ImportJiraStatus {
    /// belongs_to `jira`.
    pub jira: Option<u64>,
