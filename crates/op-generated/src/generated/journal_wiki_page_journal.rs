...
//! `JournalWikiPageJournal` — canonical class generated from `ogar_vocab::journal::wikipagejournal()`.
...
pub const CANONICAL_CONCEPT: &str = "journal::wikipagejournal";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct JournalWikiPageJournal {
    /// belongs_to `author`.
    pub author: Option<u64>,
}

impl JournalWikiPageJournal {
