...
//! `QueriesNewsFiltersNewsFilter` — canonical class generated from `ogar_vocab::queries::news::filters::newsfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::news::filters::newsfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesNewsFiltersNewsFilter {
}

impl QueriesNewsFiltersNewsFilter {
    ...
    pub fn human_name(&self) {
        // TODO: port `human_name` from Queries::News::Filters::NewsFilter
    }
}