...
//! `QueriesWorkPackagesFilterSubjectFilter` — canonical class generated from `ogar_vocab::queries::workpackages::filter::subjectfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::workpackages::filter::subjectfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesWorkPackagesFilterSubjectFilter {
}

impl QueriesWorkPackagesFilterSubjectFilter {
    ...
    pub fn r#type(&self) {
        // TODO: port `type` from Queries::WorkPackages::Filter::SubjectFilter
    }
}