...
//! `ImportJiraIssueType` — canonical class generated from `ogar_vocab::import::jiraissuetype()`.
...
pub const CANONICAL_CONCEPT: &str = "import::jiraissuetype";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct ImportJiraIssueType {
    /// belongs_to `jira`.
    pub jira: Option<u64>,
