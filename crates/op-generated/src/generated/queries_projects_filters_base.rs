...
//! `QueriesProjectsFiltersBase` — canonical class generated from `ogar_vocab::queries::projects::filters::base()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::projects::filters::base";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesProjectsFiltersBase {
}

impl QueriesProjectsFiltersBase {
    ...
    pub fn human_name(&self) {
        // TODO: port `human_name` from Queries::Projects::Filters::Base
    }
}