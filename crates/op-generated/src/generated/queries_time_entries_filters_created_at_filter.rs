...
//! `QueriesTimeEntriesFiltersCreatedAtFilter` — canonical class generated from `ogar_vocab::queries::timeentries::filters::createdatfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::timeentries::filters::createdatfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesTimeEntriesFiltersCreatedAtFilter {
}

impl QueriesTimeEntriesFiltersCreatedAtFilter {
    ...
    pub fn r#type(&self) {
        // TODO: port `type` from Queries::TimeEntries::Filters::CreatedAtFilter
    }
}