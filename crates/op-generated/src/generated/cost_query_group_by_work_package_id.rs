...
//! `CostQueryGroupByWorkPackageId` — canonical class generated from `ogar_vocab::costquery::groupby::workpackageid()`.
...
pub const CANONICAL_CONCEPT: &str = "costquery::groupby::workpackageid";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct CostQueryGroupByWorkPackageId {
}

impl CostQueryGroupByWorkPackageId {
    ...
    pub fn initialize(&self) {
        // TODO: port `initialize` from CostQuery::GroupBy::WorkPackageId
    }
}