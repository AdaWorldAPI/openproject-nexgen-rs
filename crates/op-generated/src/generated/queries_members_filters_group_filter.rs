...
//! `QueriesMembersFiltersGroupFilter` — canonical class generated from `ogar_vocab::queries::members::filters::groupfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::members::filters::groupfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesMembersFiltersGroupFilter {
}

impl QueriesMembersFiltersGroupFilter {
    ...
    pub fn joins(&self) {
        // TODO: port `joins` from Queries::Members::Filters::GroupFilter
    }
}