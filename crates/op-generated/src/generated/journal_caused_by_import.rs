...
//! `JournalCausedByImport` — canonical class generated from `ogar_vocab::journal::causedbyimport()`.
...
pub const CANONICAL_CONCEPT: &str = "journal::causedbyimport";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct JournalCausedByImport {
}

impl JournalCausedByImport {
    ...
    pub fn initialize(&self) {
        // TODO: port `initialize` from Journal::CausedByImport
    }
}