...
//! `QueriesQueriesFiltersUpdatedAtFilter` — canonical class generated from `ogar_vocab::queries::queries::filters::updatedatfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::queries::filters::updatedatfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesQueriesFiltersUpdatedAtFilter {
}

impl QueriesQueriesFiltersUpdatedAtFilter {
    ...
    pub fn r#type(&self) {
        // TODO: port `type` from Queries::Queries::Filters::UpdatedAtFilter
    }
}