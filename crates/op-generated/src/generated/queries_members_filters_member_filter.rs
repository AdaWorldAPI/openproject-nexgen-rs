...
//! `QueriesMembersFiltersMemberFilter` — canonical class generated from `ogar_vocab::queries::members::filters::memberfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::members::filters::memberfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesMembersFiltersMemberFilter {
}

impl QueriesMembersFiltersMemberFilter {
    ...
    pub fn human_name(&self) {
        // TODO: port `human_name` from Queries::Members::Filters::MemberFilter
    }
}