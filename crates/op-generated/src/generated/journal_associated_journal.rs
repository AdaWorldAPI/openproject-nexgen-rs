...
//! `JournalAssociatedJournal` — canonical class generated from `ogar_vocab::journal::associatedjournal()`.
...
pub const CANONICAL_CONCEPT: &str = "journal::associatedjournal";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct JournalAssociatedJournal {
    /// belongs_to `author`.
...
impl JournalAssociatedJournal {

    /// Struct-of-methods constructor over the ClassView × FieldMask field set.
    pub fn new(author: Option<u64>, journal: Option<u64>) -> Self {
        Self { author, journal }
    }
}