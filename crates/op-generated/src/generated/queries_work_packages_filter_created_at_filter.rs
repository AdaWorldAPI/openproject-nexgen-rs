...
//! `QueriesWorkPackagesFilterCreatedAtFilter` — canonical class generated from `ogar_vocab::queries::workpackages::filter::createdatfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::workpackages::filter::createdatfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesWorkPackagesFilterCreatedAtFilter {
}

impl QueriesWorkPackagesFilterCreatedAtFilter {
    ...
    pub fn r#type(&self) {
        // TODO: port `type` from Queries::WorkPackages::Filter::CreatedAtFilter
    }
}