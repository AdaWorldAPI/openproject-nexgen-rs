...
//! `QueriesCostTypesCostTypeQuery` — canonical class generated from `ogar_vocab::queries::costtypes::costtypequery()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::costtypes::costtypequery";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesCostTypesCostTypeQuery {
}

impl QueriesCostTypesCostTypeQuery {
    ...
    pub fn default_scope(&self) {
        // TODO: port `default_scope` from Queries::CostTypes::CostTypeQuery
    }
}