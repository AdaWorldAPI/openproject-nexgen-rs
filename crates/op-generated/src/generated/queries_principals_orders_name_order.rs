...
//! `QueriesPrincipalsOrdersNameOrder` — canonical class generated from `ogar_vocab::queries::principals::orders::nameorder()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::principals::orders::nameorder";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesPrincipalsOrdersNameOrder {
}

impl QueriesPrincipalsOrdersNameOrder {
    ...
    pub fn order(&self) {
        // TODO: port `order` from Queries::Principals::Orders::NameOrder
    }
}