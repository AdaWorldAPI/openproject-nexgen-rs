...
//! `ImportJiraPriority` — canonical class generated from `ogar_vocab::import::jirapriority()`.
...
pub const CANONICAL_CONCEPT: &str = "import::jirapriority";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct ImportJiraPriority {
    /// belongs_to `jira`.
    pub jira: Option<u64>,
