...
//! `QueriesUsersFiltersUserFilter` — canonical class generated from `ogar_vocab::queries::users::filters::userfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::users::filters::userfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesUsersFiltersUserFilter {
}

impl QueriesUsersFiltersUserFilter {
    ...
    pub fn human_name(&self) {
        // TODO: port `human_name` from Queries::Users::Filters::UserFilter
    }
}