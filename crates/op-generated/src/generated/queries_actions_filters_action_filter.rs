...
//! `QueriesActionsFiltersActionFilter` — canonical class generated from `ogar_vocab::queries::actions::filters::actionfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::actions::filters::actionfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesActionsFiltersActionFilter {
}

impl QueriesActionsFiltersActionFilter {
    ...
    pub fn human_name(&self) {
        // TODO: port `human_name` from Queries::Actions::Filters::ActionFilter
    }
}