...
//! `AttributeHelpTextProject` — canonical class generated from `ogar_vocab::attributehelptext::project()`.
...
pub const CANONICAL_CONCEPT: &str = "attributehelptext::project";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct AttributeHelpTextProject {
}

impl AttributeHelpTextProject {
    ...
    pub fn type_caption(&self) {
        // TODO: port `type_caption` from AttributeHelpText::Project
    }
}