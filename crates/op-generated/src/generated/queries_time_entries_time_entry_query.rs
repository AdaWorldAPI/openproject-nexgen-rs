...
//! `QueriesTimeEntriesTimeEntryQuery` — canonical class generated from `ogar_vocab::queries::timeentries::timeentryquery()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::timeentries::timeentryquery";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesTimeEntriesTimeEntryQuery {
}

impl QueriesTimeEntriesTimeEntryQuery {
    ...
    pub fn default_scope(&self) {
        // TODO: port `default_scope` from Queries::TimeEntries::TimeEntryQuery
    }
}