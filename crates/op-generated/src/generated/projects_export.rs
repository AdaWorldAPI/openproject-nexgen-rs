...
//! `ProjectsExport` — canonical class generated from `ogar_vocab::projects::export()`.
...
pub const CANONICAL_CONCEPT: &str = "projects::export";
...
impl ProjectsExport {
    ...
    pub fn ready_(&self) {
        // TODO: port `ready?` from Projects::Export
    }
}