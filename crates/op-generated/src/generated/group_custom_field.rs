...
//! `GroupCustomField` — canonical class generated from `ogar_vocab::groupcustomfield()`.
...
pub const CANONICAL_CONCEPT: &str = "groupcustomfield";
...
impl GroupCustomField {
    ...
    pub fn type_name(&self) {
        // TODO: port `type_name` from GroupCustomField
    }
}