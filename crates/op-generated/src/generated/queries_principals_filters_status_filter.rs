...
//! `QueriesPrincipalsFiltersStatusFilter` — canonical class generated from `ogar_vocab::queries::principals::filters::statusfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::principals::filters::statusfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesPrincipalsFiltersStatusFilter {
}

impl QueriesPrincipalsFiltersStatusFilter {
    ...
    pub fn allowed_values(&self) {
        // TODO: port `allowed_values` from Queries::Principals::Filters::StatusFilter
    }

    /// OGAR action `type` (DO-arm).
    pub fn r#type(&self) {
        // TODO: port `type` from Queries::Principals::Filters::StatusFilter
    }
}