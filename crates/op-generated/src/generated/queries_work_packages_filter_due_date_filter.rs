...
//! `QueriesWorkPackagesFilterDueDateFilter` — canonical class generated from `ogar_vocab::queries::workpackages::filter::duedatefilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::workpackages::filter::duedatefilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesWorkPackagesFilterDueDateFilter {
}

impl QueriesWorkPackagesFilterDueDateFilter {
    ...
    pub fn r#type(&self) {
        // TODO: port `type` from Queries::WorkPackages::Filter::DueDateFilter
    }
}