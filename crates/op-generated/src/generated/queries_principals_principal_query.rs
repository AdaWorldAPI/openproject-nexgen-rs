...
//! `QueriesPrincipalsPrincipalQuery` — canonical class generated from `ogar_vocab::queries::principals::principalquery()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::principals::principalquery";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesPrincipalsPrincipalQuery {
}

impl QueriesPrincipalsPrincipalQuery {
    ...
    pub fn default_scope(&self) {
        // TODO: port `default_scope` from Queries::Principals::PrincipalQuery
    }
}