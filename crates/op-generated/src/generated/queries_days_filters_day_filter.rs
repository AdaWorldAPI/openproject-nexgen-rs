...
//! `QueriesDaysFiltersDayFilter` — canonical class generated from `ogar_vocab::queries::days::filters::dayfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::days::filters::dayfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesDaysFiltersDayFilter {
}

impl QueriesDaysFiltersDayFilter {
    ...
    pub fn human_name(&self) {
        // TODO: port `human_name` from Queries::Days::Filters::DayFilter
    }
}