...
//! `QueriesDocumentsDocumentQuery` — canonical class generated from `ogar_vocab::queries::documents::documentquery()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::documents::documentquery";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesDocumentsDocumentQuery {
}

impl QueriesDocumentsDocumentQuery {
    ...
    pub fn default_scope(&self) {
        // TODO: port `default_scope` from Queries::Documents::DocumentQuery
    }
}