...
//! `QueriesActionsActionQuery` — canonical class generated from `ogar_vocab::queries::actions::actionquery()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::actions::actionquery";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesActionsActionQuery {
}

impl QueriesActionsActionQuery {
    ...
    pub fn results(&self) {
        // TODO: port `results` from Queries::Actions::ActionQuery
    }

    /// OGAR action `default_scope` (DO-arm).
    pub fn default_scope(&self) {
        // TODO: port `default_scope` from Queries::Actions::ActionQuery
    }
}