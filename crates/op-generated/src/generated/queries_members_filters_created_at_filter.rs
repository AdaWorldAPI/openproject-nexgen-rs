...
//! `QueriesMembersFiltersCreatedAtFilter` — canonical class generated from `ogar_vocab::queries::members::filters::createdatfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::members::filters::createdatfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesMembersFiltersCreatedAtFilter {
}

impl QueriesMembersFiltersCreatedAtFilter {
    ...
    pub fn r#type(&self) {
        // TODO: port `type` from Queries::Members::Filters::CreatedAtFilter
    }
}