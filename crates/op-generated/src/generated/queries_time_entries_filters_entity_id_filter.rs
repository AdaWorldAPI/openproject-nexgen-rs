...
//! `QueriesTimeEntriesFiltersEntityIdFilter` — canonical class generated from `ogar_vocab::queries::timeentries::filters::entityidfilter()`.
...
pub const CANONICAL_CONCEPT: &str = "queries::timeentries::filters::entityidfilter";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct QueriesTimeEntriesFiltersEntityIdFilter {
}

impl QueriesTimeEntriesFiltersEntityIdFilter {
    ...
    pub fn r#type(&self) {
        // TODO: port `type` from Queries::TimeEntries::Filters::EntityIdFilter
    }
}