...
//! `CustomActionsConditionsType` — canonical class generated from `ogar_vocab::customactions::conditions::type()`.
...
pub const CANONICAL_CONCEPT: &str = "customactions::conditions::type";

#[derive(Debug, Clone, Default, PartialEq)]
pub struct CustomActionsConditionsType {
}

impl CustomActionsConditionsType {
    ...
    pub fn associated(&self) {
        // TODO: port `associated` from CustomActions::Conditions::Type
    }
}